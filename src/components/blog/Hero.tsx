  ...
  return (
    <div className="relative bg-slate-900 py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
         <div className="absolute top-0 left-1/4 w-96 h-96 bg-auftek-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-auftek-300 to-emerald-300">
