...
import { Linkedin, Instagram, ArrowUpRight, LogOut, LayoutDashboard } from "lucide-react";
    ...
    return (
        <footer className="bg-black border-t border-white/10 pt-16 pb-12">
            <div className="max-w-7xl mx-auto px-6">
                ...
                {/* RODAPÉ INFERIOR + LOGIN SYSTEM */}
                <div className="border-t border-white/5 flex flex-col items-center text-center gap-4 text-xs text-zinc-600 pt-8">
                    ...
                    {/* Área de Admin / Login (Integrada ao novo layout) */}
                    {!isLoading && (
                        <div className="flex items-center gap-4 mt-2">
                            {user ? (
                                <>
                                    ...
                                    <Link
                                        href="/admin"
                                        className="text-auftek-blue hover:text-blue-400 font-bold uppercase tracking-wider flex items-center gap-1.5 transition-colors text-[10px]"
                                    >
                                    ...
                                    <button
                                        onClick={logout}
                                        className="text-red-500 hover:text-red-400 uppercase tracking-wider flex items-center gap-1.5 transition-colors text-[10px]"
                                    >
                                        <LogOut size={12} /> Sair
                                    </button>
                                </>
                                ...
                                <Link
                                    href="/login"
                                    className="text-zinc-700 hover:text-zinc-500 transition-colors text-[10px] uppercase tracking-widest"
                                >
                                    Admin Login
                                </Link>
                            )}
