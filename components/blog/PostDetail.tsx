    ...
    return (
        <article className="min-h-screen bg-white">
            ...
            <div className="w-full h-64 sm:h-96 relative bg-slate-900 overflow-hidden">
                ...
                {/* 1. Imagem de Fundo (Isolada no Client Component) */}
                ...
                {/* 2. Botão Voltar (Link funciona no Server Component) */}
                ...
                {/* 3. Conteúdo do Header (Renderizado no Servidor para SEO) */}
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="prose prose-slate prose-lg max-w-none">
                    {post.excerpt && (
                        <p className="text-xl text-slate-600 font-medium leading-relaxed mb-10 border-l-4 border-blue-600 pl-6 italic break-words">
                            {post.excerpt}
                        </p>
                    )}
                ...
                <div className="mt-12 pt-8 border-t border-slate-100">
                    ...
                    {/* 4. Compartilhamento (Isolado no Client Component) */}
