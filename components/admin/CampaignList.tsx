...
import { FolderOpen, Settings, Trash2, Archive, ArchiveRestore, Loader2, Eye } from "lucide-react";
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Gerencie suas campanhas de redes sociais e mantenha consistência nas publicações
          </p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition ${filter === 'archived'
              ? 'bg-blue-600 text-white'
              : 'bg-white text-slate-600 border border-slate-300 hover:bg-slate-50'
              }`}
          >
