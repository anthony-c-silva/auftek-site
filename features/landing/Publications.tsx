      ...
      <Section id="publicacoes" darker>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          ...
          <div className="bg-[#0e223b] border border-gray-800 p-6 rounded-xl hover:border-red-400/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Detecção de Salmonella</h3>
            <p className="text-gray-400 text-sm">Presença/Ausência a partir de 12h, com baixo custo e mínima intervenção.</p>
          </div>
          ...
          <div className="bg-[#0e223b] border border-gray-800 p-6 rounded-xl hover:border-auftek-blue/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-white mb-2">E.coli e Coliformes</h3>
            <p className="text-gray-400 text-sm">Quantificação a partir de 8h e integração automática à nuvem.</p>
          </div>
          ...
          <div className="bg-[#0e223b] border border-gray-800 p-6 rounded-xl hover:border-auftek-green/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Bioinsumos no Agro</h3>
            <p className="text-gray-400 text-sm">Monitoramento em tempo real de bioinsumos on-farm.</p>
          </div>
          ...
          <div className="bg-[#0e223b] border border-gray-800 p-6 rounded-xl hover:border-blue-300/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Água e Efluentes</h3>
            <p className="text-gray-400 text-sm">Monitoramento microbiológico de água e efluentes em tempo real.</p>
          </div>
          ...
          <div className="bg-[#0e223b] border border-gray-800 p-6 rounded-xl hover:border-orange-400/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Processos Industriais</h3>
            <p className="text-gray-400 text-sm">Análise microbiológica e físico-química de processos.</p>
          </div>
