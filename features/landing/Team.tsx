  ...
  return (
    ...
    >
      ...
      {/* ALTERAÇÃO PRINCIPAL AQUI:
         Adicionei 'py-10' (40px) neste container. 
         Como ele tem 'overflow-x-hidden', o padding precisa ser interno 
         para o card ter espaço para subir (-translate-y-2) sem ser cortado.
      */}
      <div
        ref={scrollRef}
